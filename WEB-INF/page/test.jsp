...
<title>纯javascript 日历</title>
</head>
<body >
<h1>纯javascript 日历</h1>
当前日历: <br/><input type="text" onclick="setday(this)" value="" size="20" name="postdb[posttime]" class="input_text">
<script>
<!--
...
document.writeln('              align=center><input  type=button value="重置" onclick="meizzToday()"   style="width:35px;" ');
document.writeln('             onfocus="this.blur()" title="显示当前时间" ></td><td ');
