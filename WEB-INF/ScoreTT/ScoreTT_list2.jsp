...
Integer ttid=(Integer)request.getAttribute("ttid");
...
<script type="text/javascript">
		$(function(){ 
           $("#addbox").click(function (e){
	        	   $("#addbox").autopoint( {
	   				url : 'ScoreTTAction_alltt.action',
	   				submit : [ "addbox", "" ]
	   			  });
            });
		});
					...
					<div functionId="function_86" id="searchAcc" class="searchUIBasic small"
						...
						<div align="center"><a href="ScoreTT_list.action?<%=StringUntil.menuUrl(page_menu_ID,menu_Fid,"")%>" class="STYLE1"><U>按故障单负责人统计</U></a></div>
						<form action="ScoreTTAction2_getListByTT.action?<%=StringUntil.menuUrl("") %>"  method="post">
							...
							<tr height="26px">
								...
								<td width="150px">
							<input type="text" id="addbox" view="idbox" name="word"  value="<%=word %>" class=""/><br /><br />
							<input type="hidden" id="idbox" name="ttid" value="<%=ttid %>"/>
								</td>
											...
											<div style="height: 450px">
												...
												for(i=0;i<list0.size();i++){
													Object[] product= (Object[])list0.get(i);
													    ...
													    <td><%=product[1] %></td>
													    <%if(product[2].equals("<div style='color: #FF0000'><总的平均值></div>")) {%>
														<td><%=product[2] %></td>
													    <%} else{%>
