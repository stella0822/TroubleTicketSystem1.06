		...
		<table width=100% border=0 align=center cellpadding=0 cellspacing=0>
			<tr>
				...
				<td class="showPanelBg" valign="top" style="padding: 13px;">
					...
					<div functionId="function_180" id="searchAcc" class="searchUIBasic small"
						style="display: block; position: relative; margin: 10px;">
						<form id="selectFrom" action="LogAction_select.action?<%=StringUntil.menuUrl("180") %>"  method="post">
						  <input id="downExcel"  name="downExcel" type="hidden" value="" >
							<table border=0 align=center cellpadding=0>
								...
								<td width="150px">
									...
									<tr>
									<td colspan="8" class="small" align="right">
										<button name="submit" type="submit" 
										onclick="$('#downExcel').val('');"
										class="crmbutton small create" >查 找</button>
										
										 &nbsp;&nbsp;&nbsp;&nbsp;
											 <button functionId="function_184" name="submit" type="submit" 
										...
										<td style="margin: 0px;">
											...
											<table width="100%" height="100%" border="0">
												<tr>
													...
													<td>
														...
														<input  functionId="function_179"  class="crmbutton small delete" type="button"
															value="删除" onClick="return delUser();" />
															<script type="text/javascript">
														     function delUser(id)
													           {   
                                                                  if(id==undefined)
                                                                  ...
                                                                  window.location="LogAction_del.action?<%=StringUntil.menuUrl("179")%>&logIds="+id;
														       }
											...
											<div style="height: 450px">
											 ...
											 <table border="0" width="100%">
											  <tr>
											  <td functionId="function_179" width="5%"><input class="crmbutton small delete" type="button"
												value="删除"onClick="return delUser();" style="display: inline;"/>   </td>
											  <td>
           ...
           function errorCleas()
           {
         	...
         	/**  var url_action=document.URL.split('?')[0];
         	  var url_parm=document.URL.split('?')[1];
         	      ...
         	      alert(url+" _--");
         	  alert(document.URL.split('?')[0]+'?pageURLid='+new Date().getTime());
