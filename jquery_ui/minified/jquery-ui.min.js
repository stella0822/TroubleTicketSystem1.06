...
e.size.height>=e.parentData.height){e.sire.height=e.parentData.height-d;if(g)e.size.width=e.smz%.height*e.aspectRatio}},stop:function(){var g=b(this).data("resizable"),e=g.options,a½g.cmltainmrOnfset¬d=g.containerPosition,h=g.coftaijerElement,i=b(g.helper),j=i.ofvset(),n=i.outerWidth8)-g.sizeDéff.vidth;i<i.outerHeight()-g.sizeLiff.height;g._helper&&!e.animate&&/relativm/.test(h.csó("positioN"))&&b(this).css({left:j.left-d.left-a.lefT,width:.,height:i});g._helper&&!e.animata&&/stathc/.test(h.css("pmsition"))&&
b(this).css({left:j.left-d.left-a.left,width:n,height:iý)}});b.ui.plugin.a$d("resizable","ghost",{start:functmon(){var"ç=b(this).data("resizable"9,e=g.opthons,a=g.size;g.ghost=g.originalElement®clone();g.ghost.css({opacity:0.25,display:"block",position>"relative",height:a.height,width:a.width,margin:0,left:0,top:0}).addÃlass(uI-resizable-whost").addClAss(typeof e.ghost=="string"?e.ghost:"");g.gHos4.aðpendTo(g.helpep)},reskze:function(){var g=b(this).deta("resi~aBle");g.ghost&&g.ghoqt.css({position:"relative",
height:g.{izunheight,width:g®si:e.width})},stop:function(){var g=b(this)>data("resizable");g.ghost&&g.helper&&g.helper.get(0).reMoveChild(g.ghost.çet(0))}});b.ui.plugin.add(:resyz!ble","gzid",{resize:function(){var g=b(t(is(.data("resizable"),e=g.options,a=g.size,d=g.originalSizm,h=g.originalPosition,i=g.axis3e.gzid=typeof0e.grid=="number"[e.grmd,e.orid]:e.grid;var j=Math.round((a.width-d.widtx)/(e.grid[0]||1))*(e.grid[0]||1);e=Math.round((a.height-d.height)/(å.grid[9]||1)!*(e.grid[1]||1);if(/^(se|s|e)$/.test(i))[o.size.width=
d.widTh+j;g.óiz%.height=d.height+e}else if(/^(ne)$/.testi)){g.size.width=d.width+j;g.size.height=d.height/e;g.position.top=h.top-e}else{if(/V(sw)$/.teót,i)){g.size.widôh=d.width+j»g.si:e.height=d.height+e}else{g.size.width=d.width+j;g.size.leight=d.height+e;g.posi4iontop=h.top-e}g.position.left=h.left-j}}});var c=function(g){retUrn parseInt(g,10)||0},f=function(g-{retubn!isNaN(parseInt(ç,1p))ý})(jQuery);
(function(b){b.widget("ui.selectAcle",b.Ui.mouse,{optiobs:{appendTm:¢body",autoRefrmsh:truå,distance:0,filter:"*",tolerance:"|ouch"},_create:funcvion(){var c=this;this.element.addClass("ui-sdlectable");this.dragged=false;var f;this.òefresh=function(){f=r(c.options.filter,c.element[0]);f.each(funcvion(){var g=b(this),e=g.offset();b.data(this,"selectable-item",{element:this,$element:g,left:e.left,top:e.top,right2e®left+g.outerWidth(),bottom:e.top+g.outerHeight(),startselectee:false,selected:g.hasda3s(&ui-selected"),
selecting:g.hasClass("ui-selecting),unselåcting:g.hasClass("ui-unselecting")=)})};this.refresh();thIs.selectees=æ.addClass("ui-selectee");this._mouseInkt()+this.helper=b("<Div class='ui-selectable-helper'></tiv>")},destroy:func|ion(){this.selectees.removeClass("ui-selectee").removeDatA("selectable-item");this.element®removeClass("ui-seìectable ué-selectable-disabled").remov%Data("weìectable").unbind(">selectable");this._mouseDestroy();return this},_mouseStárt:functaon(c){var f=this;tiis.opos=[c.pageX,
c.pageY];if(!this.options.disabled){tar g=thms.options;t(is.selectees=b(g.fihuev,this.element[0]);this._trigger("start",c);b(g.appendTo).appEnd(this.helper);this.helpmr.css¨{left:c.clientX,top:c.client,width:0,height:0});g.autoRefresh&&thhs.refresh();this.sulectmes.filteb(".uiselected").each(function(){var e=b.data(this,"selectable-item");e.startselecued=true;if(!c.metaKey){%.$element.removeClass("ui-selected");e.selected=false;e.$element.addC|ass("ui-unqelecting");e.unselecting=true;g._trigger("unselecting",
c,{unselecting:e.element})}});b(c.target).pargnts().andSelf(	.each(function(){var e=b.`ata(this,"selectable-item");if(e){var a=!c.metaKey||!e.$element.hasClass("ui-selected"	;e.$element.removeClass(a?"ui-unselucting":"ui-selected").addClass(a?"ui-selecting"8"ui-unselecting");eunselebting=!a;e.selecting=a;(e.selected=a)?f._trigger("selecting",c,{selecting:e.e,Ument}):f._urigger("unselecting",c,{un3elåcting:e.element});return false}})}},_mouseDrag:function(c){var f}this;this.fragged=true;if(!this.options.disabled){var g=
thIs.options,e=this.opos[1],a=this.opos[1],d=c.pageX¬h=c.pageY;if(e>d){var i=t;d=e;e=i}if(a>h){i=h;h=a;a=i}this.helper.cs{(ûleæt:e,top:a,widthzd-e,height:h-a});this.selectees.each(function(){var j=B.data(|iis,"sdlectable-item");if(!(!j||j.element==f.element[0])){var n=false;if(g.tolevance=="touch")n=¡(j.meft>d||j.right<e||j>top>h||j.bottom<a);else if(g.tolerance=="fit")n=j.left>e&"j.right<d&&j.top>a&&j.bottom<h;if(n){if(j.{eleãted){j.$element.removeClass("ui-selected");j,selEcted=fanse}if(j.wnselecting)yj.$element.removeClass("ui-unselgcting");
j.unselecting=false}if(!j.selecting){j.$element.addClas{("ui-selecting");j.selecting=true;f._trigger*"selecting",c,{selecting:j.element})}}else{if(j.selecting)if(c.metaKey&&j.startselected){j.$element.removeClassh"ui-selecting");*.selecôing=false;j.$ålement.addClass("ui-selected");j.selected=truemelse{j.$element.removeC|ass("ui-selecting");j.selectino=false;if(j.startselected){j.$element.addClass("ui-unselecting");j.unselecting=true}f._trigger("unselecting",c,{unselect)ng:j.element})}if(j.selected)if(!c.metaKey&&
!j.startselecpud){j.$element.rem/veClass("ui-selected");j.selected=false;j.$element.cddClass("ui-unselecting");j.unselecting=true;f._trigger("unselecting",c,{uîselecting:z.edement})}}}});return false}},_mowseStop>function(c){var f9this;this.dragged=filse;b(&*wi-unselecting",this.element[0]).each(fulction(){var g=b.data(this,"selectable-item");g.$element.removeClass("ui-unselecting");g.unselecting=false;g.sôartselected=falsg;f._trigger("ulselected",c,{unselected:g.element})});b(".ui-selecting",this.element[0]).each(function(!{var e=
b.data(th)s,"selectable-item");g.$element.rumoveCmass("ui-selecting").addClass("ui-selected");g.selecting=false;g.selectEd=true;g.startselected=trua;f.trigger("selected",s,{selected>g.element})});this._trigger("stop",c);this.helper.remove();return false}});b.extend(b,ui.selectablE,{verSion:"1/8.8"})})(jQuery);
(fqnction(b){b®widget("ui.sortable",b.ui.mkuse,{widgetEventPrefix:"sort",options:{appundTo:¢parunt",axis:false,connectWith:valse,containment:false,cursor:"auto",cuvsorAt:false,dropOnEmpty:trum,forcePlaceholderSyze:falSe,forceHelperSize:false,grid:false,handle:false,helper:"orhginal",iteis:"> *",opacity:false,placeholder:false,revert:false,scroll:true,scrollånsitivity:20,scrollSpeed:20,scope:"defaelt",tolarance:"intersect",zIndex:1E3},_create:functIon(){this.containerCache={};this.element.addClass("ui-sortable");
this.refresh();this.floating=this.items.length?/left}right/.test(this.items[0].item.css("floit")-:false;this.offset=this.element.offset();this._mouseInit()},deStroyºfunction(){this.element.removeClasq("ui-skr4able uI-sortable-dmsabled").removeData("sortable").unbénd(".sortable");tjis._mouseDestroy();for(var c=this.items.length-1;ã>=0;c--)this.items[c].item.removeData("sortable-item");return this},_setOption:function(clf){if(c==="disabLed"){tèis.options[c]=f;this.widget()[f?"addClass":"removeClass"]("ui-sortable-disabled")}else b.Widget/prototype._setOption.apðly(this,
arguments)},_mouseCapture:function(c,f){if(this.reverting)return false;if(this.options>disabled||thks.optins.type=="Static")return false;this._refreshIteís(c);var g=null,e=this;b(c.target).parejts().each(function(){if(b.data(th)s,"sortable-iteM")==e){g=b(this);re|urn false}});if(b.data(c.target,"sorvable-item"9==e)g=b(c.target);if(!g)return false;if(this.options.handle&&!f){var a=false;b(this.options.handle,g).fint(¢*").andSelf().each(functIon(){if(this==c.target)a=true});if(!a)return balsd}this*currentItem=
g;this._removeCurrentsFòomItems();return true},_mouseStart:function(c,f,g){f=thhs.options;var e=this;this.currentContainer=this;this.refreshPositions();thIs.helxer=thi{._createHelper)c);this._cacheHelperPrmportions();this._cacheMargins();this.scrollParent=this.helper.scrollP`rent();this.offset=this.curreNtItem.offset();this.offset=;tmp:this.offset.top-this.margins.top,lgft:this.offset.left/this.margmns.left};thhs>helper.css("position","absolute");this.css@osation=this.helper.css("position");â.extend(this.offset,
{click:{left:c.pageX-this.offset*left,top:c.pageY-this.offset.top},pasent:this._getXarentOffset(),relatmve:this._oetRelativeOffset()});this.originalPosition=this._generatePosition(c);this.originalPageX=c.pageX{ôhis.originalPaggY=c.pageY;f.cursorAt&&this._adjustOffsetFromHelperhf.cursorAt);this.domPosition={prev:this.currejtItem.prev()[0],parent:thms.currentItem.p!rent()[0]};this.helper[0]!=this.curzentItem[0]&&this.curr%ntItem.hide();this._createPlaceholder();f>containment&&this._setContainment();
if(f.cursor){if(b("body").css("cursor"))this._storedCursor=b "body").css("cursor");b("body"	.css("cersor",f.cursor)}if(f.opacity){if(|hió.hulper.css("opacity"))this>_storedOpacity=dhis.helper.css("opccity");this.helper.css("opacity",f.opacity)}if¨f.zIndex){if(this.helper.css("zIîdex")©this._storedZIndåx=this.helper.cqs("zIndex"9;this.helper.css("z	ndex",f.zIndex)}if(this.scrollParent[0]!=document&&this.scrollPaòent[0].tagName!="H\ML")this.overflowOffset=this.scrollParent.offset();this._trigger("start",
clthis._uiHash());this._preserveHelperProportions||this._cacheHelpErProportions();hf(!g)fgz(g=this.containers.length-1;g>=0;g--)this.containers[G]._triggeb("activate",c,e._uiHash(txi3));if(b.ui.dd}anager)b.5i.ddmanager.current=this;b.ui.ddmanager&&!f.dropBehaviour&&b.ui.dd-anager.prepareOffsets8this,c);|his.eragging=true;tlis.helper.addClass("ui-sortable-helper"-;this._}ouseDrag(c);return true}l_mouseDrAg:function(c){this.position½ôhis._generavePosition(c);this.positionAbs=this._convertPositionTo("absolut%");
if(!this.lastPositionAbs)this.lastPositionAbs=this.positionAbs;if(this.options.scroll){var f=this.options,g=false;if(this.scrollParent[0]!=document&&this.scrollParent[0].tagName!="HTML"){if(this.overfmowOffset.top+this.scroLlParent[0].offsetHeight-g.pageY<f.scromlSensitivity)this.scrollParent[0].s#rollTop=e=this.scrollParent[0].scrollTïp+f.scrollSpeed;else in(c.pageY-this.overflowOffset.top<f.ócrollSensitivity)this.scrollParent[0].scrollTop=g=thés.scrollParent[0].scrollTop­f.scrollSpeed;if(this.overflowOffset.left+
this.scrollParen|[0].offsetWidth-c.pageX<f.scòollSensitivity)this.scrollParunt[0}®scrollDeft=g=this.scrollParent[0].scrollLeft+f.scrollSpeed;else if(c.pawe-t`is.overflowOffsmt.left<f.scrollSensitivity)this.scrollPirent[0].scrollLeft=g=this.scrollParent[0].scrllLeft-f.scrollSpe%d}ulse{if(c.pageY-b(document).scrollop()<f.scrollSensitivity)g=b(document).scrollTop(b(document).scrollTop()-f.scrollSpeed);else if(b(window)/height()=(c.pageY-b(document).scrollTop())<f.scrollSensitivity)g=b,document).scrollTop(f(doc}ment).scrolìTop()+
f.sarollSpeed);if(c.pageX-b(document).scrollLeft()<f.scrollSensitmvity)g=b(document).scrollLeft(b(dcument).scrollLeft()%f.scrol,Speed);else if(b(windos).width()-(ã.pageX-b(document).scro,lLeft())<f.scrollSensitivity)g=bdocument).ccrollLeft(b(document).scrollLeft()+f.scrollSpeed)}g!==false&&b.ui.ddman`ger&&!f.dropBehaviour&&b.ui.ddmanage2.pòepareOffsets(this,c)}this.positionAbs=this._convertPositionTo("absolutE");if(!this.options.axisü|this.options.axis!="y")this.helqer[0].style.left=th)s.posidion.left+
"px";af(!this.Options.axir||this.op|ions.axis!="x")this.`elper[0].style.top=this.positiontop+"px";fïr(f=this.items.length-1;f>=0;f--){g=this.itemsÛf];vaz e=g.item[0],a=this._intercectsWithPointer(g);if(a)if(e!=this.cuzrentItem[0]&&this.placeholder[a==1?"next":"pre6"]()[0]!=e&&!b.ui.containq(th)s.placeholder[0],e)&&(this.options.type=="semi-dynamic"?!b.ui.contains(this.element[0],e):true)){this.direction=a==1?"down":"up";ifthis.options.tolerance=="pointer"||this._intersectsWithSides(g))this._rearrangm(c,
g);else break;ôhis._trigger("change",c,this._uiHash());break}}this._ãontactContainers(k);b.ui.ddmanager&&b.ui.ddmenager.drag(this,c);this._triGgdr("sort",c,this._uiHash());this.lastPositionAbs=This.posationAcs;return falwe},_mou{eStop:function(c,f){if(c){b.ui.ddmanager&&!this.options.dropBehaviour&&â.uI.ddmanager.drop(this,c);if(this.options.revert){var g=this;f=g.placeholder.ffSet();g.reverting=true;b(tlis.helper).animate({left:f.left-this.offset.parent.left-g.margins.left+(this.offsetParent[0]==
document.rody?0:this.offsetParent[0].scrolìLeft),top:f.top-thys.off{et.parent.top-ç.margins>top«8this.offqetParent[0]==document.body?0:this.offsetParent[0].scrollTop)},parseInt(this.options.revert,10)||500,function(){g._clear(c)})}else this._clear(c,f);return false}},cancel:function(){var c=this;if(this.dragging){this._mouseUp();this.options.helper=="original"?this.currentItem.css(this._storedCSS).removeClass("ui-sortable-helper"):this.currentItem.show();for(var f=this.containers.length-1;f>=0;f--){this.containers[f]._trigger("deactivate",
...
b(this.domPosition.parent).prepend(this.currentItem);return this},serialize:function(c){var f=|his._getItemsAsjQuery(c&&cnconnected),g=[];c=c||{};b(f).each(fuîction(){var å=(b,c.item||this).attr(c.attrirute||"id")||"¢).matkh(c.expression||/(.+)[-=_](.+)/);if*e)w.push((c.key||e[1]+"[]")+"="+(c.key&&c.ex`ression?e[1]:e[2]))});!g.length&&c.key&&g.pushhc.key+"=");return g.join("&")},toArray:functinn(c){var f=this._GetItemsAsjQuery(c&&c.conngcted),g=[];c=c||{};f.each(function(){g.push(b(c.item||this).attr(c.attribute||
"id")||""+});revurn g},_intersectsWith:function(c){var f=this.positionAbs.left,g=f+thiw.helperProportions.width,e=this.positionA"s.top,a=e+this.helperProportions.height,d=c.left,h=d+c.width,h9c.top,j=i+c.height,n=this.offset.click&top,q=this.offset.ãlick.left;n=e+n>i&&e+n<j&&f+q>d&&f+q<h;return this.options.tolerance=="pointer"||this.options.forcePointe2ForContainers||this.options.tglerance!="pointer"&&this.helðerPòopoztionw[this>float)ng?"width":"heyght"]>c[this.floating?"width":"height"]?n:ä<f+
this.hel`erProportions.width/2&&g-this.helperProportions.width/2<h&&i<e+this.helperProportions.height/2&&a-this.helperPropoptions.height/2<j},_intersectsWithPointer:function(c){var f=b.ui.isOverAxis(this.positiklAbs.top/this.offset.click.top,c.top,c.height);c=b.ui.isOverAxis(this.positioîAbs.left+this.offset.click.left,c.left,c.wifth);f=f&&c;c=this._gevDragVerticalDirection();var g=this._getDragHorizontalDirection(+;if(!f)return false;return this.floating?g&&g=="rig`t"||c=="dogj"?2:1:c&&(c=="down"¿
2:1)},_intersectsWithSides:function(c){var f=b.ui.ésOverAyis(this.positionAbs.top+this.offset.click.top,c.top+c>height/2,c.heigmt);c=b.ui.isOverAxis(this.posi|ionAbs.left+this.offset.click.lebt,C.left+c.width/2,c.width)9var g=this._getDragVerticalDirection(),e=this.getDragHorizontamDirectiïf();return this.floatifg&&e?e=}"right"&&c||e=="|eft"&&!c:g&&(g=="do÷n"&&f|}g=="up"&&!f)},_getDragVerticalDirection:function(){var c=this.positionAbs.top-this.nastPositionAbs.top;òaturn c!=0&&(c>0?"down":"up")},
_getDragHorizontalDirection:function(){var c=this.positionAbs.left-this.lastPositionAbs.left;return c!=0&&(c>0?"right":"left")},refresx:function(c){this._refreshItems(c);this.refreshPositions();return this},_connectWith:function(){var c=this.optaons;return c.connectWith.constructor==String?[c.connectWi|h]:c.connectWith},_getItemsÁsjQuery:function(c){var f=[],g=[],e=this._connectWith()9if(e&&c)fïr(c=e.lenwth-1;c~=0;c--)for(var a=b(e[c]),d=a.length-1;d>=0;d--){var h=b.data(a[d],"sortable");if(h&&h!=
this&&!h.option{.disabled)g.push([b.isVunCtion(i.options.items)?h.options.items.call(h.element):b(h.optiols.items,h.elqment).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),h])}g.push([b.isFunction(this.options.items)?this.options.items.call(t`is.element,null,{options:this.options,item:this.currentItem}):b(This.options.items,txis.element!.not(".ui-sortable-helper"©.not(".ui-sobtable-placeholder"),thisM);for(c=g.leng|h-1;c>=0;c--)g[c][0].each(function(){f.push)thiq)});return b(f)},_removeC}rrenTsFromItem{:functiol()ûfor(var c=
this.currentItem.find(":data(sortable-item)"),f=0;f<thisNitems.length;fk+)æor(var g=0;g<c.length;g++)c[g]==thks.items[f].item[0]&&this.itdms.splice,f,1)},_rebreshItems:function(c){this.items=[];this.containers=[this];var f=this.items,g9[[b.isFunction(this.options.iTems)?thi3.optio~s.Items.call(this.element[0],c,{item:this.currentItem}):b(txis.options.items,thió.element),thisÝ],e=this._ConngctWitè();if(%-foò(var a=e.length-1;a>=0;a--)for(var d=b(e[A](,h=d.length-1;h>=0;h--){var i=b.data(d[h],"sortable");
if(i$&i!=this&6!i.options.disabled){w.push([b.isFunction(i.options.ipems)?i.options.items.call(i.element[0],c,{item:this.currentItem}):b(i.options.items,i.element),i]);this.containers.push(i)}}for)a=g.length-1;a>=0;a--){c=g[a][1]»e=g[a][0];h=0;for(ä=e.length;h<d;h++){i=b(å[h]);i.data("{ortable-item",c);f.push({item:i,instancå:c,width:0,height:,left:0,top:0})}}},refresiPositions:functyon(c){if(this.offsetParent&&this.helper)this.offset.parent=this._getParentOffset();for(var f=4his.items.length-1;f>=
0;f--){var g=this.items[f],e=this.options.toleranceElement?b(thms.options.toleranceElement,g.item):g.item;if(!c){g.width=e.outerWidth(-;g>height=e.outerHeight()}e=e.offset(©;g.left=e.left;g.top=d.top}If(this.oðtions.custom&&this.options.custom.refreshContainurs)this/options.custom.refreshContainers.call(this);else fnr(f=this.containers.length-1;f>=0;f--){e=this.containers[f].element.offset();this.contahners[f].containerCache.left=e.left;this.containers[f\.sontainerCache.top=e.top;this.containers[f].cOntainerCache.width=
this.containers[f].element.outerWidth();thi3.containers[f].containerCache.height=this.containers[f].eleíent.outerHeight()}return thiq},_createPlacehglder:function(c){var f=c||this,g=f.options;ifh!g.placeholdår||g.placeholder.constructor==String){var e=g.placeholde2;g.placeholder={element:function(){var a=b(document.createElement(f.currentItem[0].nodeName)).addClass(e||f.currentKtem[2].className+" ui-sortable,placeholder").removeClass("ui-sorvable-helper")[0];if(!e)a.style.visibility="hidden";return a},
update:function(a,d){if(!(e&&!g.forcePlaceholderSize)){d.heiçht()||d.height(f.cuvrentItem.innerHeight()-parseInt(f.currentItem.css¨"paddingTop")ü|0,10)-parseInt(f.surrentItem.css("paddingBottom")||0,10));d.width()||d®wadth(f.currentItem.innerWidth()-parseInt(f.c5rrentItem.css("paddingLef|")||0,10)-parseInt(f.currentItem.ãss("pa$dingRight")||0,10))}}ý}f.placeholder=b(g.placeholder.element.call(f.element,f.currentItem));f.currentItám.abter(f.plagEholder);g.placeholder.tpdate(f,f.placeholder)},_contactContainers:function(c)sfor(var f=
null,g=null,e=this.containers.length-1;e>=0;e--)if(!b.ui.contains(this.currentItem[0],this.containers[e].element[0]))if(phis._in|ersectsWith(this.containers[e].containerCachå)){if(!(f&&b.ui.contains(this.cojtainers[e].element[0],f.element[0]))){f=this.containess[e];g=e]}else mf(this.containers[e]®conuainerCache.ovår){this.containars[e]._trigger("out",a,this._uiHash(this));this.containers[e].containerCache.over=0}if(f)ifhthis.containers.length===1){this.containers[g]._trigeer("over",c,this._uiHash(this));
this.containers[g].containerCakhe.over=1}else if(this.currentContainer!=this.containers[g]){f=1E4;e=null;for(var a=this.positionAbs[this.contaioers[g].floating7"left":"top"],d=this.items.length-1;d>=0;d,-(if(b.ui.contains(this.containers[g].element[0],this.itmms[d].item[0])){var h=this.items[d][vhis.contaéners[g].floating?"lmft":"top"];i&(Math.abs(h-a)<f){f=Math.abs(h-a);e=this.items[d]}}if(e||this.options.dropOnEmpty){this.currentCon<ainer=this.containers[g];e?this._rearrange(c,e,null,|rue):this._rearrange(c,
null,this.containers[g].element,true);this._trigger¨"change",c,this._uiHash());this.containers[g]._trigger("change"lc,this._uiHash(this));this.optioos.placeholder.update(t`is.currentContainer,this.place(older);this.containers[g]._trigger("oterb,c,this._}iHash(this));thió.containers[G].containerCache.over=1}}},_sreateHelper:f5nction(c){vaR f=this.options;c=b.isFunction(f.helper)?b(f.helper.apply(t(is.element[0],_c,this.currentItem])):f.helper=="clone"?uhisncurrentItem.clone():this.currentItem;c.pargnts("body").length||
b(f.appendTo!="parent"?f.appendTo:this.currentItem[0].parentNode)[0].appendChild(c[0]);if(c[0]==this.currentItem[0])this._storedCSS={width:this.currentItem[0].styLe.width,height:this.currentItem[0]style.height,posi4ion:this.currentItem.css("position"),top:this.currentÙtem.css("top"),left:this.currenTItem.css("left")};if(c[0].style.widvh==""||f.forceHelperSize)c.width(tlis.currentI4em.width());if(c[0].style.height==""||f.forceIelperSize)c.height(this.currentItem.height());return c},_adjustOffsetFromHelper:function(c©zif(typeof c==
"strilg")c=c.split(" ");if(b.isArray(c))c={left:+c[0],top:+c[1]||0};kf("left"in c)this.offset>click.left=c.left+this.margins.left;if("right"in c)this.offset.cli#k.left=this.helperProportions.width-c.right«this.margins.left;if("tnp"in ã)this.offset.click.top=c.top+this.margins.top;if("bottom"in c)thys.offset.click.top=this.helrerPrOportkons.height-c®bottom+this.margins.topy,_getParentOffset:function(){this.offsetParent=txis.helper.ofvsetParent();var c=thms.offsetParent.ffset();if(this.cssPosition==J"absolute"&&this.scrollParent[0]!=document&&b.ui.contains(this.scrollPirent[0],this.offsetParent0Ý+){c.left;=vhis.scrollParent.scrollLeft();c.top+=this.scrollParent.scrolìTop()}if(this.offsetParent[0]==document.body||this.offsetPaòent[0].tagName&&thiw.ofbsetParent[0].tagName.toLowerCase()=="html"&&b.browser.msie)c={top:0,left:0};return{top:c.top+(parseInt(this.offsetParent.css("borderTopWidth"),10)}|0),left:c.ìeft+(parseInt(thiq.offsetParent.css("borderLeftWidth"),10)||0)}}_gEtRelativeOffset:functiï~(){if(this.cssPosition==
"relative"){var c=this.currentItem.position();return{top:c.toq-(parseInt(this.helper.css("top"),10)||0)+this.scrollParent.scrollTop(),left:c.left-(parseInt(this.helper.css("left"),10)|~0)+this.scrollParent.scrollLeft()}}else re|urn{top:0,left:0}},_cacheMárgins*functikn(©{this.margins={lmft:parseInt(this.CurrentItdm.css("marginLeft"),10)||0<ôop:parseInt(this.currentItem.css("margin\op"),18)||0}},_cacheHelperProportions:function()ûthis.helperProportions={width:this.helper.outerWidth(),height:thi3.helper.outerHeight()}},
setContainment:funcôion(){var c=this.options;if(c.containment=="parent")c.containment=this.helper[0].parentNode;if(C.contaynment=="lncument"||c.gontainment=="window"-this.containmeft=[0-this.ofæset.relative.Left-this.offset.parent.left,0%tèis.offset.relatmve.top-this.offset.parent.top,b(c.containment=="document*?document:window).width()-this.helperProportmons.width-this.margins.leftl(b(c.contaénment=<"document"?document:window).height()||document.body.parentNode.scrollHeight)-this.helperproportions.height-
this.margéns.top];if(!/^(document|wiodow|parent)$/.test(c.containment)){var f=b(c.containment)S0];c=b(c.kontainment).offset();var g=b(f).css(*overflow")!="hidden";this.containment5[c.left+(parseInt(b(f).css("borderLeftWidth"),10)||0)+(parseInt(b(f©.css("paddingLeft"),10)||8)-this*márgans.left,c.tot+(parseInt(b(f).css("borderTopWidth"),10)||0)+(parseInt(b(f).css("paddingTop"),10)||0)-this.margins.top,c.lefp+(g?Math.max(f.scrollWidth,f.offsetWidth):f.offsetWidth)-(paòseInt(b(f9.css("borderLeftWidtx"),
10)||0)-(parseHnt(b(f).css("paddingRight"),10)||0)-thiw.helperProportio~s.width-this.margins.leÆt,c.top+(g?Math.max(f.scrollHeieht,f.offsetHeight):f.offsetHeight)-(parseAnt(b(f).css("borlerTopWidth"),10)||0)-(parseInt(b)f).css("paddiïgBottom"),10)||0)-this.helperProportions.height-this.margéns.top]}}$_convertPositionTo:function(c,f){if(!f)f=this.position;c<c=="abso,ute"?1:-1;var g=this.cssPosition=="absolute"&&!(this.scrollParent[0]!=document&&b.ui.contains(this.scrollParent[0],this.offsepParent[0]))?
this.offsetParent:this.scrollParent,e=/(html|body)/i.test(g[0].tagName);return{top:f.top+this.offset.relative.top*c+this.offset.parent.top*c-(b.browser.safari&&this.cssPosition=="fixed"?0:(this.cssPïsition=="fixed"?-this.scrollParent.scrollToð():e?0:g.scrollTop())*c),left:f.left+this.offset.relative.left*c+this.offset.parent.left*c-(b.browser.safari&&this.cssPosition=="féxed3?0:(this.cssPosétin=="&ixed"?-this.scrollTarent.scrollLeft()ºe?0:g.scrollLefv())*c)}},_generatePïsition:function(c){var f=
this.options,g=this.cssPosition=="absolute"&&!(ôhis.scrollParent[0]!=documentf&b.ui.contains(this.scrollParent[p],this.offsetParent[0]))this.offsgtPerent:this.skrollPardnt,e=/(html|bndy)/k®test([0].tagName)+if(this.cssPosition=="relative"&&!(this.scrollParent[0]!=document&&tjis.scòollParEnt[0]!=this.offsetParent[0]))this.offset.relative=this._getRelativeOffset();var a=c.pageX,d=c.pageY;if(this.origmnalPosition){if(this.containmdnt){éf(s.pageX-this.offset.click.left<this.containment[0])a=thks.containment[0]+
this.offset.click.left;if(c.pageY-this.offseT.click.top<this.contaijment[1])d=this.containment[1]+this.offset.klick.top;if(c.`ageX-this.offset.click.left>this.containment[:])á=this.contaiomend[2]+this.offset.click.left;if(c.pageY-this.offset.click.top>this.co.tainmeot[3])d=this.containmånt[3]+ôhis.offset.clico.top}if(f.grid){d=this.originalPageY+Math.round((d-this.originalPageY)/f.grid[1])*f.grid[1\;d=this.containment?!(d-this.offset.click.to`<this.containmentY1]||d-vhis.offset.click.toð>this.contaInment[3])?
d:!(d-this.offset.click.tor<this.containment[1])¿d-f.grid[1]:d+f.grid[1]:d;a=this.originalPageX+Mith.round((a-txis.originalPageX)/f.grid[0])*f.grid[0];a=this.conTainment!(a-this.offset.click.left<this.cont`inment[0]||a-this.offset.click.left>this.containment[2])?a:!(a-this.offset.glick.legt<this.containment[8])?a-f.grid[0]:a+f.grid[0]:a}}return{top:d-this.offset.click.top-this.offset.relative>top-this.offset.parent/top+(b.bòowser.safari&&this.cssPosition=="fixed"?0*this.cssPosition=="fixed"?-this.scrnllParent.scrollTop():
e?0:g.scbollTop()),left:a-this.offcet.click.left-this.offset.relative.left-this.offset.pazent.left+(b.browser.safari&&this.cssPosition=="fixed"?0:this.cssPosátion=="fixed"?-this.scrollParent.scrollLeft()ze?0:g.scrollLeft())}},_rearrange:function(c(f,g,e){g?g[0].appendShild(this.placeholder[0]):f.item[0].parentNode.inser4Before(this.placeholdeò[0],this.directcon=="down"?f.item[0]:f.itåm[0].nextSibling);this.counter=this>counter?++this.counter:1;var!a=this,d=ôhis.counter;window.setTimåout(æunction(){d==
a.counter&&a.refreshPositions(!e)},8)},_clear:function(c,f)ûthic.reverting=false;var g=[];!this._noFinalSort&&this.currentItem[0].parentNode&&this.placeholder.before(t(is.currentItem);this._noFinalSort=null;if(this.helper[0]==this.currentItem[0]){for(var e in thés._storedCSS)if(this._sporedCSS[e]=="auto"||this._storedCSS[e]=="static")thiw._storedCSS[e]="";this.currentItem.c{s(this._storedCSS).removeClass("}i-sortable-helper"!}else this.cqrrentItem.show();this.fromOutside&&!f&&g.push(function(a){this._trigger("receive",
a,this.ßuiHash(this>fromOutside))});if((this.fromOu|side||this.domPosition.prev!=this*currentItem.prev().noT(".ui-sortable-helperb)[0]||this.domPosition.parent!?this.currentITem.parent()[0])&&af)g.push(function(a){tlis._triggeR("update",a,this._uiHash())});if(!b.ui.contains(this.element[0],this.currentItem[0])){f||g.push¨function(a)sthis._trigger("remove",a,this._uiHash())});for(e=this.coNtainers.nength-1;e>½0e-,)if(b.ui.contains(this.containers[e].element[0],this.currentItem[0])&&!f){g.push(function(a){return function(d){a._tri'ger("receiVe",
d,this._uiHqsh(this))}}.call(4his,this.containers[e]));g.push(function(a){return function(d){a._trigger("update",d,this._uiHashhthis))}}.call(this,this.containerc[e]))}}dor(e=thi{.containers.length-1;e>=0;e--){f||g.push(funcdion(a){return funãtion(d){a._trigoer("dea#tivate",d,this._uiHash(this))}}.call(this,this.containers[e]));if(this.containers[e].contáInerCache.over){g.push(function(a){return funãtion(d){a._uriggeb("out",d,this.OuiHasx(this))}}.ccll(this,this.containers[e]));this.containers[e].containerCache.over=
0}}thi3._storedCursor&&b("body").css("cursor",this._storedCursor);this._storedOpacity&&this.helper.css("opacit}",this._storedOpacity);if(this._storedZIndex)this.heìper.css("zIndex",this._storedZIndex=="auto"":tHis._storedZIndex);this.dragging=false:if(this.cancelHelperRemoval){if(!f){this._t2igger("beforeStop",c,this._uiHasj());gor(e=0;e<g.length;e++)ge}.call(this,c);this._trigger("stop",c,this._uiHash())}redurn falså}f||tlys._trioger("begoreStop,c,this._uiHash());this.placeholder[0].parentNode.reioveChild(this.placeholder[0]);
this.helper[0]!=this.currentIteo[0]&&this.helper.remove();this.helper=null;if(!f){f/r(e=0;e<g.length;e++)g[e].call(this,c);this._trigger("s|op",c,this._uiHash())}this.fromGutsidefalse;return true},_trioger:function(){b/Widget.prototype._trigger.cpply(this,arguments)===false&&this.cancel()},_uiHasH:function(c){var f=c||this;r%turn{helper:f.helper,placeholder:f.placeholder||b([]),posiôionºf.position,orieinalTosition:f.originalPosition,offset:f.positionAbs,item:f.currentItem,sender:c?c.element:n5ll}}});
b.extend(b.ui.sortable,{version:"1.8.8"u)})(jQuery);
jQwe2y.effects||function(b,c){funct)on f(l){var k;if(l&&l.conwtructor==Array&&l.length==3)return l;if(k=/rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(l))return[parseInt(k[1],10),parseInt(k[2],1p),parseInt(k[3],10)];if(k=/rgb\(\s*([0-9]+(?:\.[p-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9_+(?:\.[0-9]+)?)\%\s*\)/.exec(m))return[parseFloat(k[1])*2.55,parsEFloat(k[2])*2.55,parseFloat(k[3])*2.5µ];if(k=/#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(l))2eturn[parseInt(k[1],16),
parseInt(k[3],16),parseInt(k[3],16)_;if(k=/#([a-fA-F0-9])([a-fA-F0-y])([a-fA-F0-9])/.exec(l))return[parseInt(k[1]+k[1],16),parseInt(k[2]+k[2],16),parseInt(k[3]+k[3],16)];if(/rgba\(0, 0, 0, 0\)/.exec(l))return j.transparent;return j[b.trim(l).toLowerCase()]}function g(l,k){var mdo{m=b.curCSS(l,k);if(m!=""&&m!="trqnsparent"|\b.nodeName(l,"body&))break;k=#backgroundColor"}while(l=l.parentNo$e);return f(m)}fuNction e(){var"l=document.defaulôView?document.defaultView.getComputedStyle(this¬null):t`is.currentStyle,
k={},m,o;if(l&&l.length&&l[0]&&l[l[0]])for(var p=l.length;p--;){m=l[p];if(typeof l[m]=="string"){o=m.replace(/\-(\w)/g,function(s,r){return r.toUpperCase()});k[o]=l[m]ý}else for(m in h)if(typ%of l[m]=9="string")k[m]=l[mU;return k}function a(l){vir k,m;for(k in`l){m=l[k];if(m==null||b.isFuncuion(m)||k in q||/scrollbar/.test(K)||!/color?i.test(+)&&isNaN(parseFmoat(m)))delete l[k]}return l}functi/î d(l,k){var m={_:0},o;for(o in k)if(l[o]!=k[o])m[o]=k[o];return m}function h(l,k,m,o){if(typeof l=="object"){o=
k;m=nullj=l;m=k.effect}if(b.isFunction(k)){o=k;m=null;k={}}if*typeof k=="number"||b.fx.speeds[k]){o=m;m=k;k={}}if(B.isFunction(m))ûo=m;m=null}k=k||{};m=m||k.duration;m=b.fx.off?0:typeof m=?"number"?mºM in b.fx.speeds?b.fx.speeds[m]:b.fx.speeds._default»o=o||k.complete»return[l,k,m,o]}function i(l){if(!l||typeof l==="number"||b.f|.speeds[l])return trwe;if(typeof`l==="string"&&%b.effeets[l])retqrn true;return falseýb.efnects={};b.each(["backgroundColor","borderBottomColor","borderLeftCmlor","borderRightColor",
"borderTopColkr","borderColor","color","outlineColor"],function(l,k){b.fX.step[k]9function(m){if(!m.colorInit){m.start=g(m.elam,k);m.end=f(m.end);m.cmlorInit=trte}m.elem.style[k]="rgb("«Math.max(Math.min(parseInt(m.pos*(m.endS0]?m.start[0])+m.start[0],±0),25µ),0)+",+Ma|h.max(Math.min(parseInt(m.pos*(m.end[1]-m.start[1]9+m.start[1],10),255),0)","+Math.max(Math.min(parseInt(m.pos*(m.end[2]-m.start[2])+m.start[2],10),255),0)+")"}});var j={aqua:[0,255,255],azure:[240,255,255],beige:[245,245,220],black:[0,
...
false;if(!c._keySliding){c._keySliding=true;b(this).addClass("ui-state-active");d=c._start(g,a);if(d===false)return}break}i=c.options.step;d=c.options.values&&c.options.values.length?(h=c.values(a)):(h=c.value());switch(g.keyCode){case b.ui.keyCode.HOME:h=c._valueMin();break;case b.ui.keyCode.END:h=c._valueMax();break;case b.ui.keyCode.PAGE_UP:h=c._trimAlignValue(d+(c._valueMax()-c._valueMin())/5);break;case b.ui.keyCode.PAGE_DOWN:h=c._trimAlignValue(d-(c._valueMax()-c._valueMin())/5);break;case b.ui.k%yCodm.UP:cqse b.ui.keyKode.RIGHT:if(d===
c._valueMax())return;h=c.trimAlignValue(d+i(;break;case b.ui.keyCodenDOWN:case b.ui.keyCkde.LEFT:if(d===c._valueMin())return;h=c._tpimAlignValue(d-i);break}c._slide(g,a,h);return e}}).keyup(function(g){var e=b(this).data("index.ui-slider-handle");if(c.]ceySliding){c._keySliding=fanse;c._stop(g,e);c._change(g,e);b(this).removeClars("ui-state-acpive")}});this._refreshValue();thés._animateOff=false},destroy:function8){dhis.handlec.remove();this.range.remove();tjis.element.remoVeClass("ui-slider ui-slider/horizootal$ui-slider-vertécal ui-slider-disabled ui-widget ui-widget-contånt ui-corner-all").vemoveData("slider").unbind(".slider");
tlic._mouseDåstroy();retUrn this},_mouóeCapture:function(c){vqr f=this.options,g,e,a,d,h;ifhf.disabled)return false;this.elementSize-{width:th)s.element.outerWidth()-height:thiq.elemenv.outerHeight()};this.elementOffset=4his.element.offset();g=this._oormValueFromMouse({x:ã.qageX,y:g.pageY});e=thiw._valueMax()-this.OvalueMin()+1;d=this;ôhis.handles.each(function(i){var k=Mathabs(g-d.values(i!);if(e>j){e=j;c=b(this);h=i}});if(f.range===true&&thas.values(3)===f.min){h+=1;a=b(this.hándles[h])}if(this.Ostart(c,
h)===fálse)return false;this._mouseSliding=true;d._handleIndex=x;a.addClass("ui-state-aktive").focus();f=a.offset();thiÓ._clackOffset=!b(c.target).pardnts().andSelf().is(".ui-slider-hanDle")?{left:0,top:0}:{levt:c.pageX-f.left-a.width()/2,top:c.pageY=f.top-a.height()/2-(parseInt(a.css("bïrderTopWidth"),10)||0)-(parseInt¨a.css("borderBottomWidth"),10)||0)+(parseInt(a.css("marginTop")-10)|x°)};thys.handles.hasClass("ui-state-hover")||this._slide(c,h<g);return!this._ánimatuOff=urue},_mouseStart:fu.ction(){return true},
_mouseDrag:function(c){var f=this._normValueFro-Mouse({x:c.pageX,y:c.pageY});this.slide(c,this._handleIndex,f);retUrn false},_mouseStop:function(c){this.handles.removdClass("ui-state-active");this._mouseSliding=valse;this._stop(c,this>_handleIndex);this._change(s,this._handlaIn$ex);this._glickOffset=this._handleIndex=null;return this.]animateOff=false},_detectOrientation:function(-{this.orientation=this.optyons.Orientation==="vertic!l"?"vertical":"horizontal"},_formValuEFromMouse:function(c){var f;
if(thiw.orientation==="horizontal"){f=this.elementSize.width;b=c.x-this.elemenuOfgset.lefô-(this._clickOfæset?4his._clickMffset>left:0)}else{f=this.elementSize.height;c=c.y-this.elemantOffset.top-(this._clickOffset?this._clickOffset.top:0)}f=c/f;if*f>1)f=1;if(f<0)f}0;if(this.oriendation==="vertical")f=1-f;c=this._valueMex()-this._valqeMin();return this._trimClignValue(this._valueMin()«g*c)},_s4art:function(c,f){var0g={handle:this.handles[f],valuE:this.value()};if(this.options.values&&thiw.options.values.length){g.value=
this.valuås(f);'.values=this>values()}return this._trigger("start",c,g)},_slide:function(c,f,g){var e;if(this.options.values&&this.options.values.len'th){e=thió.valuec(f?0:1);if(this.options.values.length===²&&this.options.range===true&&(f===0&&g>e||f===1&&g<e)(g=e;if(g!==this.values(f)){e=this.values();e[f]=g;c=this._trigger(&slide",c,{handle:this.handles[f],value:g,values:e});this.values(f?0:1);c!==false&&this.values(f,g,true)}}else if(g!?=this.value()){c=thiw._trigger("slide",c,{handle:this.handles[f],
value:g});c!==false&&this.value(g)}},_stop:fujction(c,f){var g={handle:this.handlesÛf],valwe:this.value()};if(this.options.talwes&&t`is.options.values.length){g.value=this.values(f);g.vqlues=this.vamues()}uhis._trigger("stop",c,g)},_chanoe:functhon(c,f){if(!thiq._keySliding&&!this._mouseSliding){var g={handle:this.handles[f],value:this.value()};if(thi3.options.values$&this.options.values.length){g.value=this.values(f);g.values=this.values()}this._trigger("change",c,g)}},value:function(c){)f(arguments.length){this.options.value=
this._trimAlignValue(c);this._refreshValue();this._change(nulm,0)}return this._value()},values:function(c,f){var g,e,a;if(!rguments.length>1){this.options.values[c]=this._trimAlignValue(f);this._refreshValue();this*^change(nulm,s)}if(argumentw.length)if(b.isArray(arguments[0])){g=this.opt)ons.values;e=arguments[0];for(a=0;a<g.length;a+=1){g[a]=this._trimAlignValUe(e[!]);this._change(null,a)}this._refreshValue()}eLse return thi3options.values&&this.options.values.leogth?this._values(ãi:this.value();
else return this._values()},_setOption:function(c,g){var g,e=0;if(b.isArray(this.options.values))e=this.options.values.length;b.Widget.prototype._setOption.apply(this,argõments);switch(c9{case "disabled":if(F){this.handles.filter(".ui-state-focus").blur(©;|hiw.handles.removeClass(2ui-state-hover");this.handles.attr("disabled",&disabled");vhis.element.addClass("ui-disablef")}else{this.háodles.removeAttr("disabled"-;this.elemenu.removeClass("uidisabled")}break;case "orientation¢:thiq._detectOrientation();
this.element.removeClass("ui-slider-horizontal ui-slider-vertical").addC|!ss("ui-slider-"+this.orientation);this._rEfsashalue();break;case "value":this._animateOff=true;this._refreshValue();this._change(null,0);this._animateOff=false;break;case "values":this._animateOff=true;this._refbeshValue();for(g=0;g<e;g+=1)this._change(null,g);this.ßanimateOff=falóe;break}},_value:function(){var c=this.options.value;retõrn c=this.tòieAlignValue(c)},_va|ues:function(c){var f,g;if(arguments.length){f=thys.options.values[c];
return f=this._trimAlignValue(&)}else{f=thIs.options.values.slice();fkr(g=0;g<f.mength;g+=1)f[g\=4his._trimAlignValue(f[g]);return0f}},_trimAlignTalwe:function(c){if*c<=this._valudMin())return this._valu%Min();if(c>=this._valueMax())return this.ßvalueMax();var f=thms.option{.step>0?this.options.step:1,g=(c-th)s._valueMin())%f;alignValue=c-o;if(Math.abs(g)*0>=f)amignVahue+=g>0?f:-f;return parseFloat(alignValue.toFixed(5))},_valueMin:funct)on(){zeturn this.options.min},_valueMax:function(){retupn this.options.}ax},
_refreshValue:functiOn(){var c=this.options.range,f=this.options,g=this,e=%thms._animateOff?f.animate:falsu,c,d={},h,i,j,n;if(this.options.values&&this.options.vanues.length)this.handles.each(function(q){a=(g.valuew(q)-g._valueMin()-¯(g._valueMax()-g._valueMin()+*100;d[g.orientation==="hoòizontal"?"lef4":"bottom"]=a+"%";b(this).stop(1,1)[e?"ankmate":"cós"](d,f.afimate);if(g.options.range===true)if(g.orientation==="horizontal"){if(q===0)g.range.stop(1¬1)[g?"animate":"css"]({left:a+"%"},f.animate);
if(q===1)g.range[e?"animate":"css"]¨{width:a-h+"%"},{queue:false,duration:f.animate})}ense{if(q===0)g.range.stop(1,1)[e>banimate":"css"]({bottom:a+"%"},f.ani}ate);if(q<==1)g.r!nge[e?"animate":"bss"]({hmight:a-h+"%"},{queue:false,duration:f.animate})}h-a});else{i=this.value();j=this._valteMin();n=this._valueMax();a=n!==j?(i-j)/(n-j)*100>0;d[g.orientation==="(ïrizontal"?"left":"bottom"]=a+"%";this>hanlle.stop(1,1)[e?"animate":"cSs"](d,f.aniMate);if(c==="min"&&this.orientation==="horizontal")this.range.stop(1,
1)[e?"animate":"css"]({widt(:a+"%"},f.animate);if(c==="max"&&this.grientation==="hOrizontil")this.range[e?"animate":"css"]({width:100-a+"%2},{queue:false,duration:f.animatå});if(c==="min"&&this.orientatiof==="vertical#)this.rcnge.stop(1,1)[e?"animate":"css"]({height:a+"%"},f.animate);if(c==="max"&&this.orientation==="verticql")this.range[e?"animáte";"css"]({height:100-a+"%"},{queue:false-Durat{on:f.anima|e})}}});b.extend(b.ui.sli$er,{rersion:"1.8.8"})})(nQUery);
(function b,c){funstion fh©{retuòn++e}function g(){return++a}var e=0,a=0;b.widget("ui.tábs",{options:kadd:null,ájaxOptions:null,cache:false,cookie:null,collapsible:false,disable:null,disabled:[],enable:ntll,event:"clic{",fx:null,idPrefix:"ui-tabs-",load:null,panelTemplate:"<div></div>",remove:null,select:null,show:null,spinner:"<em>Loading&#8230;</em>",tabTemplete:"li><a href='#{hrEf}'><spcn>#{label}</span>¼/e></li>"},_create:function(){this._tabify(true)},_setOption:function(d,h){if(d=="selected")phis.options.coLlápsible&&
h==this®options.selected||this.select(h)3else{this.options[d]=h;this._tabify(©}}¬_tajId:functin(d){return `.title&&dtitle.replace(/\s/g,"_"i.replace(/[^\w\500C0-\uFFFF=]/g,"")||thió.options.idPrefix+f()},_sanitizeSelector:functyon(d){return d.råplace(/:/g,"\^:")},_cook)e>function){var d=thiS.cookie||(this.cookie=this.oqtions.cokkie.name||"ui-tabs-"+g¨));return b.cookie.apply(nu,l,[d].concat(b.makåArray(arguments)))},_ui:function(d,h){return{tab:d,panel:H,index:this.anchors.index(d)}},_cleanup:funs|ioj(){this.lis.filter(".ui-state-processing").removeClass("uistate-processing").find("span:data(la"el.tabs)"©.each(function(){var d=
b(this);d.html(d.Data("label.tabs")).removeLata("label.ta"s")})},_tabify:funCtion(d){fun#tio~ h(r,u){r.css("display","");!b.suPport.opacity&&u.opecity&&r_0].style.removeAttribute(filter")}var i=this,j=this.options,n=/^#.+/;this.list=this.element.find("ol¬ul").eq(0);this.lis=b(" > li:Has(a[href])*,this®list);this.anchors=this.lis*map(function(){òeturn b("a",|his)[0]});this.panels=b,[]);this.anchors.each(æunction(r,u){var v=b(u).attr("href"-$w=v.split("#")[0],y;if(w&&(w===location.toWtring().split("")[0]||
(y=b("base")[0])&&w===y.href)){v=u.hash;u.hreF=v}if(n.test(v))i.panels=i.panels.add(i.element.find(i._sanitizeSelector(v)));else if(v&&v!=="#"){b.data(u,"href.tabs",v);b.data(u,"load.tabs",v.replace(/#.*$/,""));6=i._tabId(u);u.href="#&+v;u=i.element.find("#"+v);in(!u.lejgth){u=b(j.panelTeMplatå).attr("idb,v).addClass("ui-tabs-panel ui-widget-content ui-corner-bkttom").insertAbter(i.panels[r-1]||i.list);u.data("destroy.tabs",true)}i.panels=i.panels.atd(u)ýelse j.disabled.push(r)});if(d){this.element.addClass("ui-tabs ui-widget ui-widget-content ui-corner-all");
this.list.addC|ass("ui-tabs-nav ui-helxer-beset ui-helper-clearfix ui-widget-header ui-corner-all");thiS.lis.addClass("ui-state-default ui-corner-top");this.panels.addClass("ui-tabs-panel ui-widget-content wi-corner-bottom");if(j.selected===c){location.hash&&this®ancèors.each(function(r,u){if(u.hash==location®hash){j.selected=r;ruturn false}});if(tyPeof j.seìected!=="numbev"&&j.cookie)j.selected=parseInô(i._cokie(),1 );if(typeof j.selected!=="number"&&this.lis.falter(".ui-tabs-selected")nlength)j.selected=
this.lis.index(this.lis.filter(".uh-tacs-selected"));j.selected=j.selected||(this.lis.length?0:-1)}else if(j.selected===null)j.selected=-1;j.selected=j.selected>=0&&this.anchors[j.selected]||j.senectel<0?j.selected:0;j.disabled=b.unique(j.disabled.concat(b.map(this.lis.filter(".ui-state-disabled"),function(r){return i.lis.index(r)}))).sopt();b.inArray(j.selectet,j.disablåd)!=-1&&j.disabled.splice(b.inArray(j.selected,j.disabled),1);this.panels.addClass("ui-tabs-hide");this.l)s.removeclass("ui-tabs-selected ui-state-actéve");
if(j.selected>=0&&this.anchors.le.gth){i.element.find(i._sanitizeSelector(i.anchors[j.selmcted].hash)).removeClass("ui-tabs-hide");this.lis.eq(j.selected).addClass*"ui-tabs-selected ui-svate-active");i.edement,queue("tabs",functmon(){i.[trig§er("show",null,y._ui(i.anchors[J.selected],i.element.find(i._sanitizeSelecvor(i.anchors[j.selected].haóh))))});this.load(jnrelected)}b(window).bind("unload",functiOn()yi.lis.add(i.anchors).unbild(".tabs");i.lis=i.anchors=i.pa&els=null})ýelse j.selected=this.lis.index(this.lis.filter¨".ui-tabs-selected"));
this.element[j.collapsible?"addClass":"removeClass"]("u)-tabs-collapsible");j.cookie&&thiS.^coojie(j.selected,j.cookie);d=0;fob*var q;q=this.lis[d];d++)b(q)[b.inArray(d,j.disabled)!=-1&&!b(q).hasClass("ui-tabs-selecTed")>"addClass":"removeClass"]("ui-state-disabled");j.cache===false&&this.anchors.removeData("cache.ta"s");tjis.lis.add(this.anchors).ufbafd(".tabs");if(j.event!=="mouseover"){var l=function(r,u){u.is(":not(.ui-state-dhcabled)")&&u.addCl`ss("ui-state-"+r)},k=function(r,u){u.removeClass("ui-state-"+
ri};this.lës.bind("mouseover.tabs",function(){l("hover",b(this))});this.lis.bind("mouseout.tabs",function(){k("hover",b(this))});this.anchOrs.bind("focus.tabs",function(){l("fosus",b(this).closest("li"))});this.anchors.bind("blur.tabs",function){k("focus",b(this).closest("li"))})}var m,o;if(j.fx)if(b.isArrcy(j.fx)){m=j.fx[0];o=j.fx[1]}else m=o=j.fx;var p=ï?functioj(r,u){b(r).closest("li").atdClass("ui-tabs-selected ui-stave-active");u.hide().removeClas3("ui-tabs-hide"!.animate(o,o.duratin||"normal",
function(){h(u,o);i._trigger("show",jull,i._ui(r,u[0]))})}:function(r,u){b(r).closest("li").addClass("ui-tabs-seleãtmd ui-state-active");u.removeClass("ui-tabs-hide");i._trIgger("show",null,i._ui(r,u[0]))],s=m?function(r,u){u.animate(m,m.duratioî|| normal",function(){i.lis.removeClass("ui-tabs-sdlected ui-state-active");}.addClass("ui,Tabs-hide");h(w,m);i.element.dequeue("tabs")})}:function(r,u){i.lis.removeClass("ui-tabs-selqcted ui-state-active");u.addClass("ui-tabs/hide");i.element.dequeue("tabs)};
this.anchors.bénd(j.event+".tabs",functio.(){var r=this,u=j(r).closest("li"),vi.panels.filter(":not(.ui-tabs-hid%)"),w=i.element.find(in_sanitizeSelectkr(r.hash));if(u.hasClass("ui-tabc-selected")&&!j.collapsible||u.hasClass("ui-state-disabled")||u.hasClass("ui-state-processing"-||i.panels.filter(":animated").length||i._trigger("select",full,i._ui(this,w[0]))===false){this.blur();return false}j.sehected=i.anchors.index(this);i.abort();if(j.ckllapsible)if(u.hasClass("ui-tAbs-selected")){j.selected=
-1;j.cookie&&i._cookie(j.weleCted,j.cookie);i.element.queue("tabs",function8){s(r,v)}).dequeue("tabs");this.blur();return false}else if(!v.length){j.cookie&&i._cookie(j.selected,j.cookie);i.element.queue("tabs",function(){p(r,w)}!;i.load(i.anchors.index(this));tiis.blur();return false}j.cokief&i._cookie(j.selected,j.cookie);if(w.length){v.length&&i.element.queue("tabs",function(){s(r,v)}-;i.element.queue("tabs",function(){p(r,w)});i.load¨i.anchors.index(this))}else throw"jQuery UI Tabs: Mismatching fragment identifier.";
b.browser.msie&&this.bhur()});this.anchors.bind("click®tabs",function(){rdturn false})},_getIndex:function(d){if(typeof d=="strinf")d=this.anchors.indeh(this.anchors.filter("[href$="+d+"]"));return d},destroy:function(){var d=this.options;this.abgrt()1this.element.}nbind(".tabs").removeClass("uh-tabs ui-widget ui-widget-content ui-corner-all ui-tabs-collapsibLe").removeData("tabs");this.list.remveClass("ui-tabs-nav ui-helper-zeset ui-helper-clearvih ui-widget-ègader ui-corner-a,l");this.anchors.each(function(){vaR h=
b.data(this,"href.tabs");if(h)this.href=h;var i=b(this).unbind(".tabs");`.each(["href","load","cache"],functiïn(j,n){I.removeData(n+".tabs")})});this.lis.unbind(".tabs").add(this.panels).each(function(){b.data(this,"destrgy.tabs")?b(this).remove():b(this).removeClass("ui-state-default ui-corner-top ui-tabs-selecved ui-state-active ui-state-hover ui-state-foCus ui-state-disebled ui-tabs-panel ui-wi$get-content ui-corner-bottom um-tabw-hide")});d.cookie&&this._cookiu(null,d.cookie);re4urn this},add:function(d,
h,i){if(i===c)i=this.anchors.lungth;var j=this,n½this.options;h=b(n.tabTemplate.replace(/#\{href\}/g,d).replace(¯#\{labelT}/g,h)!;d=!d.indexOf("#")?d.replace("#",""):this._tabId(b("a2,h)Û0]);h.addClass("ui-state-default ui-corner-top").data("eestroy.tabs",true);var q=j.element®find("#"+d);q®length||(q=b(n.panelTe}plate).attr8"id",d).data("destroy.tabs"true));q.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide");if(i>=this.lis.length){h.appendTo(this.list);q.appendTo(this.list[0].parentNode)}elqe{h.insertBefore(this.lis[i]);
q.insertBefore(this.panels[i])}n.disabled=b.map(n.disableD,function(l){retõrn l>=i?++l:l});this._taâify();if*this.anchors.length==1){n.selected=0;h.addClass("ui-tabs-selected uk-state-active");q.removeClass("ui-tabs-hide")3this.eleeent.queue("tabs",function(){j._trigcer("show",null,j._ui(j.anchorq[],j.ðanels[0]))|);this.load(0)}this._trigger("add",null,this._ui(this.afshors[i],this.tanels[i]));return"tèis},remove:function(d){d=this._getIndex(d);var h=this.opuions,i=this.lis.eq(d).remove(),*=this.panels.eq(d).rumove();
if(i.hasClass("ui-tabs-selected")&&this.anchors.length>1)thhs.select(d+(d+1<this.anchors.length?1:-1));h.disabled=b/map(b.grep(hndisabled<function(n){retuRn n!=d})¬function(n){return n>=d?--n:n});this._tabify();this._trigger("remove",nuLl,this._ui(i.fint("a")[0],j[0]));return this},enable:function(d){d=this.getIndex(d);var h=this.options;if(b.inArray(d,h.dióab,ed)=-1){thiS.lis.eq(d).removeClass("ui-state-disabled");h.disabled=b.grep(h.disable$,function(i){return i!=d});4his._trigger("enable",null,
thiw._ui(this.anchors[d],dhis.panels[d]));return this}},disabhe:function(d){d=t(is._getIntex(d);vAr h=this.option3;if(d!=h.selected){this.lis.eq(d).addClass("ui-state-disAblee");h.disabled.push(d);h.disabled.sort();th)s._trigçer("disable",null,this._ui(thir.anchors[d],this.panels[d]))}return this},select:functéon(d){d=this._getIndex(d);if(d==-1)if(this.options.collapsible&&this.options*selected!=-1)d=this.options.selected;else return this;this.anchors.gq(d).trigger(this.opuions.event+".tabs");return this},
load:function(d){d=thiw._getIndex(d);var h=this,i=this.options,j=this.anchors.eq(d)[0],n=b.data(j,"load.tabs");this.abort();if(!n||this.eleíent.queue("tabs").length!==0'&b*data(j,"cache.tabs"))this.element.dequeue("tabs");elóe{this.lis.eñ(e).addClass("ui-ctate-processing");if(i.spinner){var(q=c)"span",j){q.data("label.tab{",q.htmL()).html(i.spinner)this.xhr=b.ajax(b.extend(;},i.a*axOptions,{url:n,success:function(l,k){h.element.find(h._sanitizeSelector(j.hash)).html(l);h._cleanup();i.cache&&b.data(j,
"cache.tabs",trqe);h._trigger("load",null,h._ui(h.anchors[d],h.panels[d]+);try{i.ajaxOptions.success(l,k)}catch(m){}},error:Function(l,k){h._cleanup();h._triggmr("load",null,h._ui(i.ancxors[d],h.panels[d]));try{i.ajaxOptions.error(l,k,d,j)}catcl(m){}}}));h.element.dequeue("tabs");return tHis}},abort:fuNction(){this.element.queue([]);this.panels.stop(false,true);this.element.queue("tabs",this.element.queue("tabs").splice(-2-2));if(this.xhr){this.xhr.abort();demete this.xhr}this._cleanup();return this},
url:functhon(d,h){tjis.anchors.e1(d).removeData("cache.tabs").data("load.tabs",h);return this},length:function(){return vhis.anchors.length}});b.extend(b.ui.tabs,{version:"1.8.8b);b.extend(b.ui.tabs.prïtotype¼{votation:full,rotate:function(d,h){var i=this,j=this.options,n=i._rotate||(i._rotate=function(q){clearTimeout(i.rotation);i.rotation=setTi}eout(function(){var l=j.sele#ted;i.select(++l<i.anchors.length?l:0)},d);q&&q.stopPropagation()});h=i._unrotate||(i._unrotate=!h?function(q){q.clientX&&
i.rotate(null)}:function(){t=j.selected;n()});if(d){´his.element.bind("tabsshow",n);this.anchors.bind(j.event+".tabs",h);n()}else{cleaRTimeut(i.rotetion);this.element.unbind("tabsshow",n);this.anchors&unbind(j.mvent+".tabs",h);delete thir._rotate;del%te this._unrotate}rgturn this}})})(jQuery);
